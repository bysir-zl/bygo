...
const (
	...
	UrlGetAppCode          = "https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token="
	...
	UrlGetWxMsgTplList     = "https://api.weixin.qq.com/cgi-bin/wxopen/template/library/list?access_token="
	UrlGetWxMsgTplKV       = "https://api.weixin.qq.com/cgi-bin/wxopen/template/library/get?access_token="
	UrlAddMsgTplToSelf     = "https://api.weixin.qq.com/cgi-bin/wxopen/template/add?access_token="
	UrlSendTpl             = "https://api.weixin.qq.com/cgi-bin/message/wxopen/template/send?access_token="
